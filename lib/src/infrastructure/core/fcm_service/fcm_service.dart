...
import 'package:offline_service_booking/src/infrastructure/core/fcm_service/fcm_navigation_service.dart';
...
class FcmService {
  ...
  Future<void> initialize() async {
    ...
    _foregroundNotificationTempTest(); // Temporary test for foreground notifications
  }

  // Temporary test for foreground notifications-------------------
  void _foregroundNotificationTempTest() async {
        ...
        flutterLocalNotificationsPlugin.show(
          ...
          const NotificationDetails(
            android: AndroidNotificationDetails(
              'channel_id', // must match the one you define
              'channel_name',
              importance: Importance.high,
  ...
  //         );
  //         //pay notification sound
  //         // await FlutterRingtonePlayer.play(
  //         //     fromAsset: Utils.getAssetAudio("notify"), // will be the sound on Android
